	...
	public static void main(String[] args) {
		...
		try {
			...
			if (action == PUBLISH) {
				...
				System.out.println("Starting pub at: " + startingTime + "\tEnding pub at " + endingTime + "\tDelta: "
				...
				long endingTime = System.currentTimeMillis();
				System.out.println("Arrival of first msg: " + startingTime + "\tArrival of last msg " + endingTime
						+ "\tDelta: " + (endingTime - startingTime));
			}
			es.close();
		} catch (Exception ex) {
			ex.printStackTrace();
