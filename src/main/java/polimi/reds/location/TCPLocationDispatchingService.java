...
/**
 * This class implements the <code>LocationDispatchingService</code> by using a
 * TCP connection to connect to the REDS dispatching service.
 */
public class TCPLocationDispatchingService extends TCPDispatchingService implements LocationDispatchingService {
	protected Location myLocation;

	/*
	 * public TCPLocationDispatchingService() { super(); }
	 */
	...
	/**
	 * Check whether a message is instance of <code>LocationMessage</code>. If
	 * <code>true</code> returns the payload, else it returns the message
	 * itself.
	 * 
	 * @param m
	 *            the message
