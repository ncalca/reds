 ...
 * that begin with a given string, or messages that end with a given string,
 * or messages that contain a given string.
 * 
...
/** A constant to specify exact matching. */
  ...
  /** A constant to specify that the filter matches messages that begins with
   * a given string. */
   ...
   * matching strategy.
   *
   * @param filter The filtering string that identifies this filter.
   * @param typeOfMatch The matching strategy (e.g. exact, begins, ...)
   */
  ...
  /**
   * Builds a new <tt>TextFilter</tt> with a <tt>null</tt> filtering
   * string and an exact matching strategy.
   *
   * @see #TextFilter(String,int)
   */
  public TextFilter() {
   ...
   * 
   * @param v  Value to assign to the filtering string
   */
