...
/**
 * Thrown to indicate that a method has been passed a condition whose name is
 * different to the other condition name
 * 
 */
public class NameMismatchException extends RuntimeException {

	private static final long serialVersionUID = 2192606405030061767L;
