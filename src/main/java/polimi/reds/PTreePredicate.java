 ...
 * <code>PTreeFilter</code> filter. A filter of that type is always composed of
 * a conjunction of <code>PTreePredicate</code> basic predicates.
 */
public interface PTreePredicate extends Serializable {
	/**
	 * Must return a representation of the test contained in this predicate,
	 * e.g. the variable this predicate refers to.
	 * 
	...
	/**
	 * Must return a string representation for the result of the test contained
	 * in this predicate. This last will basically be a combination of the
	 * chosen comparator and the referred value.
	 * 
	 * @return a string representation for the result contained in this
	 *         predicate.
	 */
	 ...
	 * implementation of this method can greatly improve the overall efficiency
	 * of the filtering algorithm.
	 * 
	 * @param p
	 *            the predicate to be examined for logical implication.
	 ...
	 * functioning of the <code>PTreeTable</code>. In particular, timust return
	 * true iff o is an object of type PTreePredicate and
	 * <code>this.getTestVariable().equals(p.getTestVariable())</code> and
	 * <code>this.getResult().equals(p.getResult())</code> both return TRUE.
	 * 
	 * @param o
	 *            the object to be examined for equality.
