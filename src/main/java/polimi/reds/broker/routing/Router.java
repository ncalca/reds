...
/**
 * This interface is the "core" of a REDS broker. Classes that implement this
 * interface constitutes the main component of a REDS broker. It is registered
 * to the <code>Overlay</code> to receive messages coming from the other nodes
 * of the network. In most cases it delegates its main functionalities to the
 * other components that compose a REDS broker: namely, the
 * <code>RoutingStrategy</code> and the <code>ReplyManager</code>. It holds the
 * common data structure managed by those components: the
...
public interface Router extends PacketListener {
	 ...
	 * If <code>message</code> is instance of<code>Repliable</code>, the
	 * <code>Router</code> needs to activate the <code>ReplyManager</code> to
	 * record the message in the <code>ReplyTable</code>.
	 * 
	 * @param neighborID
	 ...
	 *            the routing strategy that the given broker has to use to route
	 *            messages.
	 */
	 ...
	 *            the subscription table used by this broker.
	 */
	 ...
	 * 
	 * @param replyManager
	 *            the reply manager used by this broker.
	 */
	 ...
	 * 
	 * @param replyTable
	 *            the reply table used by this broker.
	 */
	 ...
	 * neighbor or dropped if no information about its sender is contained in
	 * the reply table.
	 * 
	 * @param reply
