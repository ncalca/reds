...
/**
 * This class represents the network abstraction for the upper levels. It offers functionalities to dialogue with the neighbors of
 * the local node. It stores informations about the set of neighbors of the local node and it can send messages to them.<br>
 */
public interface Overlay {
	 ...
	 *  <li><code>Router.UNSUBSCRIBE</code> -> <code>Transport.FILTER_CLASS</code></li>
	 *  <li><code>Router.UNSUBSCRIBEALL</code> -> <code>Transport.FILTER_CLASS</code></li>
	 *  <li><code>Router.REPLY</code> -> <code>Transport.REPLY_CLASS</code></li>
	 *  <li>Other -> <code>Transport.MISCELLANEOUS_CLASS</code></li>
	 * <ul>
	 * </p>
	 * <p>
	 * If the destination is not connected to the local node it throws a <code>NotConnectedException</code>.
	 * </p>
	 * @param subject the subject of the message
	 * @param payload the message
	 * @param receiver the receiper of the message
	 * @throws NotConnectedException the local node is not connected to the specified destination 
	 */
	public void send(String subject, Serializable payload, NodeDescriptor receiver) throws NotConnectedException;
	/**
	 * Send a message with a specified subject and traffic class to a destination.<br>
	 * If the destination is not connected to the local node it throws an exception.
	 * @param subject the subject of the message
	 * @param payload the message
	 * @param receiver the receiper of the message
	 * @param trafficClass the message traffic class
	 * @throws NotConnectedException the local node is not connected to the specified destination 
	 */
	 ...
	 * <p>
	 * The <code>Overlay</code> stores the new <code>PacketListener</code> in order to register it to all the <code>Transports</code>
	 * that could be successively added. 
	 * </p>
	 *
	 * @param listener the new listener  
	 * @param subject the subject the listener is interested to
	 */
	 ...
	 * 
	 * @param listener the new neighbor
	 */
	...
	/**
	 * Add a new neighbor at the specified URL. If the operation goes well it returns the identifier of the new neighbor, else it
	 * throws an Exception.
	 * 
	 * @param url the URL of the new neighbor
	 * @throws AlreadyAddedNeighborException the node is already a neighbor of the local node
	 * @throws MalformedURLException the given url does not respect the correct syntax 
	 * @throws ConnectException the connection has failed
	 ...
	 * 
	 * @param removedNeighbor the neighbor to be removed
	 */
	 ...
	 * 
	 * @param excludedNeighbor the neighbor that must not be returned
	 ...
	 * This means starting all the componets that form the <code>Overlay</code> itself (i.e.: all the <code>Transport</code>s and
	 * the <code>TopologyManager</code>).
	 */
	public void start();	
	/**
	 * Stop the <code>Overlay</code>.<br>
	 *This means stopping all the componets that form the <code>Overlay</code> itself (i.e.: all the <code>Transport</code>s and
	 * the <code>TopologyManager</code>).
	 */
	public void stop();
	/**
	 * The URLs where the broker listens for incoming connections.<br>
	 * These urls identify the <code>Transport</code>s active into this <code>Overlay</code>. If one <code>Transport</code> is
	 * removed, its url is removed too.
	 * @return an array of urls.
	 */
	public String[] getURLs();
	/**
	 * Add a new <code>Transport</code> to the <code>Overlay</code>.<br>
	 * Note: this method register to the given <code>Transport</code> all the listeners previously registered to the other 
	 * <code>Transport</code>s, included the <code>TopologyManager</code>'s <code>LinkListener</code>s. 
	 * @param t the new <code>Transport</code>
	 */
	public void addTransport(Transport t);
	/**
	 * Stop and remove the given <code>Transport</code>.<br>
	 * If this <code>Transport</code> has some open connections, these connections are closed before removing the 
	 * <code>Transport</code>.
	 * @param t the <code>Transport</code> to be removed
	 */
