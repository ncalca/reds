...
/**
 * This is a simple implementation of the <code>TopologyManager</code> that does not make any attempt of reconfiguration. Its behaviour is
 * the same as the one of the <code>AbstractTopologyManager</code>.
