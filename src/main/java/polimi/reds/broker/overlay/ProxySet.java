...
/**********************************************************************
 * As its name suggests a <code>ProxySet</code> contains a set of Proxy
 * representing local node's neighbors, which can be accessed through their
 * identifier.
 **********************************************************************/
class ProxySet {
	 ...
	 * 
	 * @param nodeID
	 *            The identifier of the neighbor that must be get.
	 * @return The neighbor having the given identifier that is included into
	 *         this set or <code>null</code> if this set does not include such a
	 *         neighbor.
	 */
	...
	/**
	 * Returns all the <code>Proxy</code> included into this set as a single
	 * collection.
	 * 
	...
	/**
	 * Returns all the <code>Proxy</code> included into this set except for a
	 * single one, that one having the given identifier.
	 * 
	 * @param nodeID
	 *            The identifier of the <code>Proxy</code> that has to be
	 *            excluded.
	 * @return A collection of the <code>Proxy</code> included into this set
	 *         excluding that one having the given identifier.
	 */
	 ...
	 * 
	 * @param nodeID
	 *            The identifier of the node whose presence in this set is to be
	 *            tested.
	 ...
	 * 
	 * @param nodeID
	 *            The identifier of the node that has to be removed.
	 */
	...
	/**
	 * Returns the number of brokers in this set (nodes can be brokers or
	 * clients).
	 * 
	...
	/**
	 * Returns the number of clients in this set (nodes can be brokers or
	 * clients).
	 * 
