...
public class LocalTransport extends AbstractTransport {
   ...
   * @throws ConnectException the <code>LocalTransport</code> cannot open any connection
  ...
  /**
   * Confirm opening of the connection, send the local ID, connect the neighbor
   * to the nertwork. If the connection is already opened, throw a
   * ConnectionException.
   * 
   * @param neighbor who requires the opening of a connection
