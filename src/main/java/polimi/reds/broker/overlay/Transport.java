...
/**
 * This interface represents the dataLink layer of a REDS broker. Its purpose is
 * to control connections to the neighbors of the local node and to send them
 * messages.<br>
 * Classes that implement this interface should differ one another only for the
 * type of protocol they offer.
 * 
 */
public interface Transport {
	...
	/**
	 * Open a connection to a node located at a specified URL. If the connection
	 * is successfully opened it returns the remote node's
	 * <code>NodeDescriptor</code>, else it throws an Exception.
	 * 
	 * @param url
	 *            the url of the node
	 * @return the <code>NodeDescriptor</code> of the remote node
	 * @throws MalformedURLException
	 *             when <code>url</code> is not a REDS valid URL
	 * @throws ConnectException
	 *             when the connection fails and is closed
	 */
	 ...
	 * 
	 * @param closedNeighbor
	 *            the remote node of the closed connection
	 */
	 ...
	 * 
	 * @param listener
	 *            a component interested into the opening of new links
	 */
	 ...
	 * 
	 * @param listener
	 *            a component interested into the closing of links
	 */
	 ...
	 * 
	 * @param listener
	 *            a component interested into the brutal closing of links
	 */
	...
	/**
	 * Send a message with a specific subject to a node neighbor of the local
	 * node.
	 * 
	 * @param subject
	 ...
	 *            the message
	 * @param receiver
	 *            the receiver of the <code>payload</code>
	 * @param trafficClass
	 *            the traffic class of the message to be sent
	 * @throws NotConnectedException
	 *             the <code>destination</code> is unknown or is not connected
	 *             to the local node
	 */
	 ...
	 * 
	 * @param listener
	 *            the listener for all the messages of the given subject
	 */
	...
	/**
	 * Add a new traffic class creating and starting the corresponding parsing
	 * thread.<br>
