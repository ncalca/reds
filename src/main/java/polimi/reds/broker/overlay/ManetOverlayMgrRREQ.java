...
class ManetOverlayMgrRREQ extends ManetOverlayMgrMessage {
	...
	// Is true if this RREQ message is used to reconnect two partitions of the
	// tree.
	...
	/**
	 * Build a RREQ Message with a given sender Id, broadcast Id and
	 * groupSequenceNumber.
	 * 
	 * @param senderId
	 *            the Id of the sender of the message.
	 * @param broadcastId
	 *            the broadcast Id of the sender.
	 * @param groupSequenceNumber
	 *            the most recently known group sequence number.
	 */
	 ...
	 * 
	 * @param reconnectFlag
	 *            the reconnect flag for this message.
	 */
	 ...
	 * 
	 * @param groupSequenceNumber
	 *            the group sequence number in this message.
	 */
	 ...
	 * 
	 * @param b
	 *            TRUE for setting the the OverlayLimited flag in the message.
	 */
